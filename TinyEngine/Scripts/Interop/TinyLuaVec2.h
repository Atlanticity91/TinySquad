...
#include "TinyLuaPoint.h"

namespace TinyLua::Vec2 {
	...
	tiny_dll void Create( lua_State* context, const tiny_vec2& vector );

	tiny_dll void Create( lua_State* context, lua_Number x, lua_Number y );
