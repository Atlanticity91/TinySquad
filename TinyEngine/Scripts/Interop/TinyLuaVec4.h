...
#include "TinyLuaVec3.h"

namespace TinyLua::Vec4 {
	...
	tiny_dll tli_prototypefn( TranslateW );
	...
	tiny_dll void Create( TinyLuaContext& context, const tiny_vec4& vector );
