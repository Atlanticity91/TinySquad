...
tiny_enum( TinyStorageTypes ) {
	...
	TS_TYPE_STATIC = 0, // GAME + ECS SYSTEM + STATIC IMUTABLE MEMORY
	TS_TYPE_DYNAMIC,	// RESIZABLE STORAGE FOR GAME LIFETIME
	TS_TYPE_THREAD,		// THREAD SPECIFIC STORAGE
	TS_TYPE_GRAPHICS,	// GRAPHICS SPECIFIC STORAGE ( VULKAN MEMORY )
	TS_TYPE_ASSETS,		// ASSET MANAGER MEMORY BUFFER
	TS_TYPE_HEAP,		// TICK LIFETIME MEMORY POOL
