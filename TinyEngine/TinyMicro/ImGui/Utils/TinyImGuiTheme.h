...
#include "TinyImGuiContext.h"

tm_class TinyImGuiTheme final {
...
public:
	...
	~TinyImGuiTheme( ) = default;

	void Initialize( );

	TinyImGuiTheme& Set( ImGuiStyleVar variable, const float value );

	TinyImGuiTheme& Set( ImGuiStyleVar variable, const ImVec2& value );

	TinyImGuiTheme& Set( ImGuiCol color, const ImVec4& value );

	TinyImGuiTheme& Reset( );
