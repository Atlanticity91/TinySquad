...
tiny_enum( TinyInputModifier ) {
	...
	TI_MODIFIER_SHIFT	  = TINY_LEFT_SHIFT( 1, 0 ),
	TI_MODIFIER_CTRL	  = TINY_LEFT_SHIFT( 1, 1 ),
	TI_MODIFIER_ALT		  = TINY_LEFT_SHIFT( 1, 2 ),
	TI_MODIFIER_SUPER	  = TINY_LEFT_SHIFT( 1, 3 ),
	TI_MODIFIER_CAPS_LOCK = TINY_LEFT_SHIFT( 1, 4 ),
	TI_MODIFIER_NUMS_LOCK = TINY_LEFT_SHIFT( 1, 5 )
