...
bool ImGui::CompressTTF(const char* filename, const char* symbol, bool use_base85_encoding, bool use_compression, bool use_static)
{
    // Read file
